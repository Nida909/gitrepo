...
if(str.equals(num)) {
    history1 mObj = new history1("Your Contact :" + h1.child("CustomerContact").getValue(), "Pick Up Location :" + h1.child("MilkmanLoc").getValue(), "Price :" + h1.child("Price").getValue(), "Drop Off Location :" + h1.child("DropOffLoc").getValue());
